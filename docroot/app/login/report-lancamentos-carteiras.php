...
<head>
    ...
    <title>Minha Carteira - Relatório de Lançamentos por Carteiras</title>    
...
<body>
    <div class="container">
        ...
        <h1>Relatório de Lançamentos por Carteiras</h1>
    </div>
    ...
    <div class="containercad" style="margin-top: 0px;">        
            ...
            <?php
                ...
                echo "<a class='link-as-button' href='gerar_lancamentos_carteiras.php?carteira=$carteira&data_inicio=$data_inicio&data_final=$data_final'>GERAR PDF DA PESQUISA</a><br><br>";
            } else {
    ...
    if (!empty($dados['PesqCarteiras'])) {
        ...
        $query_lancamentos = "SELECT ld.codigo, ld.descricao, ld.valor, ld.data_pagamento, ld.data_vencimento, cat.descricao AS descricao_categoria, car.descricao AS descricao_carteira, ld.situacao  
                              ...
                              WHERE ld.carteira = :carteira AND ld.data_vencimento BETWEEN :data_inicio AND :data_final
