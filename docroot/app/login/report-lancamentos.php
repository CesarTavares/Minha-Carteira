...
<head>
    ...
    <title>Minha Carteira - Relatório de Lançamentos por data</title>   
...
<body>
    <div class="container">
        ...
        <h1>Relatório de Lançamentos por data </h1>
    </div>   
            ...
            <form method="POST" action=""> 
                ...
                <div class="containercad" style="margin-top: 35px;">
                    ...
                    <?php
                        ...
                        echo "<a class='link-as-button' href='gerar_lancamentos_pdf.php?$query_params'>GERAR PDF DA PESQUISA</a><br><br>";
                    ?>         
        ...
        <div class="containercad"> 
            ...
            $idUsuario = $_SESSION['codigo'];
                if(!empty($dados['PesqData'])){
                    ...
                    $query_lancamentos = "SELECT ld.descricao, ld.valor, ld.data_pagamento, ld.data_vencimento, 
                      ...
                      WHERE ld.data_vencimento  BETWEEN :data_inicio AND :data_final 
