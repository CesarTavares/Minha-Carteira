...
<body>
        ...
        <form id="formulario" action="cad-lancamentobd.php" method="POST" enctype="multipart/form-data">
            <div class="row-flex">
                <div class="col">
                    ...
                    <input type="date" style="padding: 15px; font-size: 20px; border-Color: black" name="data_pagamento" id="data_pagamento" value="<?php echo isset($_GET['data_pagamento']) ? htmlspecialchars(urldecode($_GET['data_pagamento'])) : ''; ?>">
                </div>
                    ...
                    <div class="row-flex centralizar-h">
                        <div class="col" style="margin-top: 15px;">
                            ...
                            <select name="categoria" id="select-categoria">
                                ...
                                if ($conexao) {
                                    // Prepara e executa a consulta para buscar as categorias de despesa do usuário
                                    $query = "SELECT codigo, descricao FROM categorias WHERE codigo_usuario = :usuario AND tipo = 'despesa'
    ...
    <dialog id="carteira_modal" class="popup-content">
        ...
        <label style="padding: 1px 95px" ;>Tipo de Carteira de Pagamento</label>
        <div class="centralizar-pop-up">
