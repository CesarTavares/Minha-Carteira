...
<head>
    ...
    <title>Minha Carteira - Relatório de Lançamentos por Categorias</title>    
...
<body>
    <div class="container">
        ...
        <h1>Relatório de Lançamentos por Categorias</h1>
    </div>
            ...
            <form method="POST" action="">               
                    ...
                    <div class="col">
                                ...
                                <select name="categoria" id="categoria">
                                    ...
                                    if ($conexao) {
                                        ...
                                        $query = "SELECT codigo, descricao FROM minhacarteira.categorias WHERE codigo_usuario  = :codigo_usuario AND tipo = 'despesa'";
                ...
                <div class="containercad" style="margin-top: 0px;">
                    ...
                    <?php
                        ...
                        echo "<a class='link-as-button' href='gerar_lancamentos_categorias.php?categoria=$categoria&data_inicio=$data_inicio&data_final=$data_final'>GERAR PDF DA PESQUISA</a><br><br>";
                        } else {
    ...
    if (!empty($dados['PesqCategorias'])) {
        ...
        $query_lancamentos = "SELECT ld.codigo, ld.descricao, ld.valor, ld.data_pagamento, ld.data_vencimento, cat.descricao AS descricao_categoria, car.descricao AS descricao_carteira, ld.situacao 
                              ...
                              WHERE ld.categoria = :categoria AND ld.data_vencimento BETWEEN :data_inicio AND :data_final
        ...
        if ($result_lancamentos->rowCount() != 0) {  
            ...
            while ($row_lancamento = $result_lancamentos->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<tr>
                            ...
                            <td>" . formatarData($row_lancamento['data_pagamento']) . "</td>
                            <td>" . formatarData($row_lancamento['data_vencimento']) . "</td>
